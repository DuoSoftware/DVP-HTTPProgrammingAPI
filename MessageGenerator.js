...
var playanddetectspeech = function(text, actionURL, tempURL, inputTimeout, regTimeout, grammar, engine,  language, ttsengine, voice){
    ...
    var data = util.format("say:%s detect:%s {start-input-timers=false,no-input-timeout=%d,recognition-timeout=%d}%s?language=%s",
...
var Ards = function (actionURL, tempURL, skill,skilldisplay, company, tenant, ardsholdmusic, ardsfirstannouncement, ardsannouncement, announcementtime, positionannouncement, language, priority, maxqtime, dialtime, bussinessunit) {
